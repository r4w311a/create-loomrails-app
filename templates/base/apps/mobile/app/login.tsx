    ...
    >
      <View className="flex-1 justify-center px-6">
        <View className="mb-8">
          ...
          <Text className="text-base text-slate-400">Sign in to your account</Text>
        </View>
        ...
        <View className="gap-5">
          ...
          <TouchableOpacity 
            className={`bg-indigo-500 p-4 rounded-xl items-center mt-2 ${isLoading ? 'opacity-70' : ''}`}
            onPress={handleLogin}
            disabled={isLoading}
          >
            {isLoading ? (
        ...
        <View className="mt-8 flex-row justify-center">
          ...
          <ExpoLink href="/register" asChild>
            <TouchableOpacity>
              <Text className="text-indigo-400 font-medium text-sm">Sign up</Text>
            </TouchableOpacity>
          </ExpoLink>
        </View>
      </View>
